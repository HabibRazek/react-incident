                ...
                <div class="row">
                    <div class="col-md-2 sd">
                        ...
                        <ul class="nav flex-column mt-3">
                            <li class="nav-item">
                                <Link class="nav-link text-light" to="/stats">Stats</Link>
                            </li>
                            <li class="nav-item">
                                <Link class="nav-link active text-light" to="/sideincident">Incidents</Link>
                            </li>
                            <li class="nav-item">
                                <Link class="nav-link text-light" to="/side">Users</Link>
                            </li>
                            <li class="nav-item">
                                <Link class="nav-link text-light" to="/msg">Messages</Link>
                            </li>
                            <li class="logout">
                                <hr class="text-light" />
